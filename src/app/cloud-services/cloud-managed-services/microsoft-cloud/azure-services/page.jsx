import AzureServicesContent from '@/components/pages/services/cloud-managed/AzureServicesContent';
...
export const metadata = {
  ...
  alternates: { canonical: 'https://gulfstreamtech.com.sa/cloud-services/cloud-managed-services/microsoft-cloud/azure-services/' },
  openGraph: {
    title: 'Azure Managed Services Saudi Arabia | GulfStream',
    description: 'Azure managed services in Saudi Arabia — VMs, AKS, Azure SQL, Entra ID & Defender. 29% cost reduction, 24/7 monitoring & FinOps optimization.',
    url: 'https://gulfstreamtech.com.sa/cloud-services/cloud-managed-services/microsoft-cloud/azure-services/',
    type: 'website',
...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'What are Azure Managed Services?', acceptedAnswer: { '@type': 'Answer', text: 'Azure Managed Services means outsourcing your Azure operations, security, monitoring, and optimization to certified cloud engineers. We handle everything from infrastructure to applications and compliance.' } },
    { '@type': 'Question', name: 'How much do Azure Managed Services cost in Saudi Arabia?', acceptedAnswer: { '@type': 'Answer', text: 'Costs vary with subscription count and support requirements. We provide tailored quotes after a free assessment. Most clients see ROI within 90 days through cost savings.' } },
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 5, name: 'Azure Services' },
  ],
};
