    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          '@type': 'FAQPage',
          mainEntity: [
            { '@type': 'Question', name: 'What industries does GulfStream Technologies support?', acceptedAnswer: { '@type': 'Answer', text: 'GulfStream Technologies provides industry-specific cloud solutions for retail, healthcare, logistics, technology/SaaS, and professional services enterprises across Saudi Arabia — with tailored multi-cloud managed services across AWS, Azure, Google Cloud, and Oracle Cloud for each sector.' } },
