...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'How much do AWS Managed Services cost in Saudi Arabia?', acceptedAnswer: { '@type': 'Answer', text: 'AWS Managed Services costs vary based on your environment size, number of accounts, and support level required. GulfStream Technology offers flexible pricing tiers starting from basic monitoring to fully managed operations. Book a free assessment for a tailored quote.' } },
