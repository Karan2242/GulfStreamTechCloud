...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'How much do Azure Managed Services cost in Saudi Arabia?', acceptedAnswer: { '@type': 'Answer', text: 'Azure Managed Services costs depend on your environment complexity, number of subscriptions, and support level. GulfStream Technology offers flexible pricing from basic monitoring to fully managed operations including hybrid cloud support. Book a free assessment for a quote.' } },
