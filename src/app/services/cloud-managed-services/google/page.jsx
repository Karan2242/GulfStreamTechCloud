...
export const metadata = {
  ...
  keywords: ['Google Cloud managed services Saudi Arabia', 'GCP managed services Riyadh', 'BigQuery management Saudi Arabia', 'GKE managed services', 'Google Cloud cost optimization', 'GCP monitoring Saudi Arabia'],
  alternates: { canonical: 'https://gulfstreamtech.com.sa/services/cloud-managed-services/google/' },
  openGraph: {
    title: 'Google Cloud Managed Services Saudi Arabia | GulfStream',
    description: 'Google Cloud (GCP) managed services in Saudi Arabia — GKE, BigQuery, Cloud Run & Cloud SQL. 28% cost reduction, 24/7 monitoring & data analytics.',
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 4, name: 'Google Cloud Managed Services' },
  ],
};
