...
export const metadata = {
  ...
  alternates: { canonical: 'https://gulfstreamtech.com.sa/services/cloud-managed-services/microsoft-cloud/azure-services/' },
  openGraph: {
    title: 'Azure Managed Services Saudi Arabia | GulfStream',
    description: 'Azure managed services in Saudi Arabia — VMs, AKS, Azure SQL, Entra ID & Defender. 29% cost reduction, 24/7 monitoring & FinOps optimization.',
    url: 'https://gulfstreamtech.com.sa/services/cloud-managed-services/microsoft-cloud/azure-services/',
    type: 'website',
