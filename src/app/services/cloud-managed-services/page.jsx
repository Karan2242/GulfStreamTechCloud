...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'What are cloud managed services?', acceptedAnswer: { '@type': 'Answer', text: 'Cloud managed services involve outsourcing 24/7 cloud operations — monitoring, security, optimization, and maintenance — to a certified provider like GulfStream Technology. We manage AWS, Azure, Oracle Cloud, and Google Cloud environments for enterprises across Saudi Arabia.' } },
    ...
    { '@type': 'Question', name: 'Do you operate in Riyadh, Jeddah, and Dammam?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. GulfStream Technology serves enterprises across Riyadh, Jeddah, Dammam, and the wider GCC region with 24/7 cloud managed services, on-site consulting, and regulatory compliance expertise.' } },
  ],
};
